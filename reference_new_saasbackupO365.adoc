...
* SaaS Backup for Microsoft 365 现在支持 Exchange Online 用户的高级搜索功能。启用后，您可以在备份数据的最后六个月内搜索单个，共享和归档邮箱项。
+
link:task_using_advanced_search.html["使用 Microsoft Exchange Online 高级搜索"]
